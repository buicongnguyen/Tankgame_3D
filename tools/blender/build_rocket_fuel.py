...
def cylinder(parent,loc,r,depth,m,r2=None):
 if r2 is None:bpy.ops.mesh.primitive_cylinder_add(vertices=16,radius=r,depth=depth)
 else:bpy.ops.mesh.primitive_cone_add(vertices=16,radius1=r,radius2=r2,depth=depth)
