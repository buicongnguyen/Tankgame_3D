...
export class Input {
  ...
  constructor(canvas:HTMLCanvasElement){
    window.addEventListener('keydown',e=>{
      ...
      if(!e.repeat){if(e.code==='KeyC')this.onAction('switch');if(e.code==='KeyR')this.onAction('artillery');if(e.code==='KeyQ')this.onAction('shield');if(e.code==='KeyE')this.onAction('repair');if(e.code.startsWith('Digit'))this.onAction(e.code.slice(-1));}
    });
