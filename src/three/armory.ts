...
export const WEAPONS:WeaponDefinition[]=[
 ...
 {name:'Flamethrower',label:'FLAMETHROWER',description:'12 m / 70° cone. Heavy close-range fire + 2s burn. Cover blocks flames. Unlimited fuel.',price:480,damage:24,speed:0,reload:.12,splash:0,flame:true},
];
