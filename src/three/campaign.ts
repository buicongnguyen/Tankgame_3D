...
export const MISSIONS: Mission[] = [
  ...
  { biome:'river', parTime:120, boss:'missile', name:'River Run', sector:'FLOODED VILLAGES', kind:'assault', briefing:'The valley is safe, but isolated settlements still need supplies. The Tempest missile carrier guards the patrol. Leave its red circles before impact, then strike its open core. Bridges keep your speed; crossing the water slows both sides. Green repair centers restore your hull.', radio:'IVO / Tempest: leave the red zones, then hit its exposed core.', debrief:'The river villages have supplies again. A transport is waiting below the snow line.', objective:'Clear the river patrol', count:6, duration:0, reward:340 },
