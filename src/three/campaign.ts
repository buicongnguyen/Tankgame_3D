...
export interface Mission { biome:Biome; parTime:number; commandBriefing?:string; commandRadio?:string; boss?:'rail'|'missile'|'walker'|'helicopter'|'spider'|'laser'; name: string; sector: string; kind: MissionKind; briefing: string; radio: string; debrief: string; objective: string; count: number; duration: number; reward: number; }
export const MISSIONS: Mission[] = [
  ...
  {"name": "Cinderfall", "biome": "volcanic", "parTime": 150, "sector": "ACTIVE VOLCANIC BASIN", "kind": "assault", "briefing": "Clear the armored patrols below the erupting volcano. Red circles warn where rocks will land. They damage both sides and can ignite fuel. Leave each circle before impact or lure a hostile tank into it.", "radio": "MARA / Falling rocks hit both sides. Clear the red circles.", "debrief": "The patrol breaks beneath the falling rock. Desert settlements are waiting for the relief convoy.", "objective": "Clear the volcanic patrol · dodge rockfalls", "count": 6, "duration": 0, "reward": 460},
