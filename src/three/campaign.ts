...
export interface Mission { biome:Biome; parTime:number; commandBriefing?:string; commandRadio?:string; boss?:'rail'|'missile'|'walker'|'helicopter'|'spider'|'laser'|'quad-mech'|'siege-mech'|'missile-truck'; name: string; sector: string; kind: MissionKind; briefing: string; radio: string; debrief: string; objective: string; count: number; duration: number; reward: number; }
