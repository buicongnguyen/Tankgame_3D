...
export const MISSIONS: Mission[] = [
  ...
  {"name": "Cinderfall", "biome": "volcanic", "boss":"jet", "commandBriefing":"Ash Falcon marks a flight corridor before its strafing run. Leave the amber line; attack with ordinary guns during its low return pass, or laser and rockets while airborne.", "commandRadio":"MARA / Jet inbound. Dodge the marked corridor; fire during its low return.", "parTime": 150, "sector": "ACTIVE VOLCANIC BASIN", "kind": "assault", "briefing": "Clear the armored patrols below the erupting volcano. Red circles warn where rocks will land. They damage both sides and can ignite fuel. Leave each circle before impact or lure a hostile tank into it.", "radio": "MARA / Falling rocks hit both sides. Clear the red circles.", "debrief": "The patrol breaks beneath the falling rock. Desert settlements are waiting for the relief convoy.", "objective": "Clear the volcanic patrol · dodge rockfalls", "count": 6, "duration": 0, "reward": 460},
