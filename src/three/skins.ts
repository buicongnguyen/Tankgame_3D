...
export const SKINS=[
 ...
 {id:'coral',name:'Coral Flash',price:300,stars:2,starColor:'#e12457',bonus:'+18% movement speed',speed:1.18,damage:1,shield:3},
 {id:'tropical',name:'Tropical Wave',price:350,stars:3,starColor:'#1553c4',bonus:'+1.5 seconds of shield',speed:1,damage:1,shield:4.5},
 {id:'acid',name:'Lime Viper',price:450,stars:4,starColor:'#ff9eec',bonus:'+15% weapon damage',speed:1,damage:1.15,shield:3},
 {id:'aurora',name:'Electric Aurora',price:800,stars:5,starColor:'#7932df',bonus:'+10% speed / damage · 5 s shield',speed:1.10,damage:1.10,shield:5},
 ...
 {id:'bastion',name:'Verdant Bastion',price:650,stars:3,starColor:'#44ff81',bonus:'6 s shield',speed:1,damage:1,shield:6},
 {id:'sprint',name:'Cobalt Sprint',price:700,stars:3,starColor:'#459bff',bonus:'+30% speed',speed:1.3,damage:1,shield:3},
 {id:'lance',name:'Ruby Lance',price:850,stars:3,starColor:'#ff4569',bonus:'+30% damage',speed:1,damage:1.3,shield:3},
 {id:'quartermaster',name:'Quartermaster',price:550,stars:3,starColor:'#d06cff',bonus:'+25% ammo · 200 flame bursts',speed:1,damage:1,shield:3,ammo:1.25},
] as const;
