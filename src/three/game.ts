...
export class Game {
  ...
  airlifts=new Airlifts();skirmish:SkirmishSession|null=null;skirmishDraft=loadSkirmish();
  ...
  prepare(index:number,level=unlockedLevel(this.save,index)){
    ...
    this.escortDeploying=false;this.skirmish?.deploy(this);this.enemies.forEach((u,i)=>{if(!this.training&&!this.skirmish&&!u.pending)assignPatrol(this,u,i);});this.allies.setup(this);
