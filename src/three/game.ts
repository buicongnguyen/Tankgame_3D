...
if(cover.kind==='barrel'||cover.kind==='fuelcrate'){this.explode(cover,cover.kind==='fuelcrate'?7:5,cover.kind==='fuelcrate'?110:65);}}
  ...
  complete(){
    ...
    this.lastReward=this.stageResult.total;this.persist();this.finishDelay=1.5;this.finishDeadline=performance.now()+1500;this.setPhase('finishing');this.updateHud();
