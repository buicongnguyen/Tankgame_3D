...
export class Game {
  ...
  moveUnit(unit:Unit,dx:number,dz:number,dt=1/60){
    ...
    const motion=tractionMotion(this.world.environment.biome,p,unit.velocity,dx,dz,dt);
