...
export class Environment{
 ...
 build(world:World,index:number){
  ...
  // Flank landmarks share the route landmarks' single instanced concrete draw.
  for(const [x,z] of [[-61,33],[61,-35]])if(!overlapsReservation(world.layout,{x,z,w:14,d:10}))world.addLandmarkBlock({x,z,w:14,d:10});
